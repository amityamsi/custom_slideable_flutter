      ...
      child: SlidableGroupBehavior<SlidableAutoCloseNotification>(
        child: SlidableGroupBehavior<SlidableAutoCloseBarrierNotification>(
          onNotification: (notification) {
            ...
            final previousOpenForThatTag = openSlidables.putIfAbsent(
              key,
              () => 0,
            );
...
/// INTERNAL USE
class CustomSlidableAutoCloseBehaviorInteractor extends StatelessWidget {
  /// INTERNAL USE
  const CustomSlidableAutoCloseBehaviorInteractor({
    super.key,
...
class SlidableAutoCloseInteractor extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return CustomSlidableAutoCloseNotificationSender(
      groupTag: groupTag,
      controller: controller,
...
/// INTERNAL USE
class CustomSlidableAutoCloseNotificationSender extends StatelessWidget {
  /// INTERNAL USE
  ...
  void _handleStatusChanged(AnimationStatus status) {
    ...
    if (willBarrierBeEnabled != barrierEnabled) {
      dispatcher = SlidableGroupNotification.createDispatcher<
              SlidableAutoCloseBarrierNotification>(context,
          assertParentExists: false);
  ...
  Widget build(BuildContext context) {
    return SlidableGroupBehaviorListener<SlidableAutoCloseBarrierNotification>(
      ...
      child: GestureDetector(
        ...
        child: AbsorbPointer(absorbing: absorbing, child: widget.child),
      ),
    );
  }
}
