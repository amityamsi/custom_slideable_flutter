...
class CustomSlidableGestureDetector extends StatefulWidget {
  ...
  @override
  _CustomSlidableGestureDetectorState createState() =>
      _CustomSlidableGestureDetectorState();
}

class _CustomSlidableGestureDetectorState
    extends State<CustomSlidableGestureDetector> {
  double dragExtent = 0;
