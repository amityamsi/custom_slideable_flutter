...
class CustomSlidableDismissal extends StatefulWidget {
  const CustomSlidableDismissal({
    super.key,
    required this.axis,
  ...
  @override
  _CustomSlidableDismissalState createState() =>
      _CustomSlidableDismissalState();
}

class _CustomSlidableDismissalState extends State<CustomSlidableDismissal>
  ...
  @override
  void didUpdateWidget(covariant CustomSlidableDismissal oldWidget) {
