...
typedef CustomSlidableActionCallback = void Function(BuildContext context);
...
class CustomCustomSlidableAction extends StatelessWidget {
  ...
  /// other [CustomCustomSlidableAction]s.
  /// {@endtemplate}
  final int flex;
  ...
  void _handleTap(BuildContext context) {
    ...
    if (autoClose) {
      CustomSlidable.of(context)?.close();
    }
  }
}
...
class CustomSlidableAction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (label != null) {
      ...
      children.add(Text(label!, overflow: TextOverflow.ellipsis));
    }
    ...
    return CustomCustomSlidableAction(
